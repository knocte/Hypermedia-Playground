namespace SharpRestFulie.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("SharpRestFulie.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("SharpRestFulie.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("SharpRestFulie.Infrastructure")
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("SharpRestFulie.Web.Mvc")
                    .BasedOn<NHibernateQuery>()
                    .WithService.DefaultInterfaces());

            container.Register(
                AllTypes.FromAssemblyNamed("SharpRestFulie.Infrastructure")
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("SharpRestFulie.Tasks")
